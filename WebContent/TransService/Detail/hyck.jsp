...
<div class="wrapper">
    <div class="navpostion c">
        ...
        <a href="${pageContext.request.contextPath}/TransService.html">物流服务</a>
        <span style="min-width: 10px;"></span>&gt; 
        海运出口
    </div>
</div>
<div class="wrapper">
    <div class="main_left">
        <div id="main_wlfw">
            ...
            <div id="wlfw_msg">
                <h1>海运出口</h1>
                <p>锦程国际物流集团是国家商务部批准的一级国际货运代理企业，同时也是国家交通部批准的具有无船承运业务经营资格的无船承运人。主营海运集装箱货物、海运散杂货运输等海运服务。集装箱运输以欧洲、地中海、中东、东南亚和美国航线的出口为主要业务，是COSCO、MAERSK、CHINA SHIPPING、MSC、CMA、HANJIN、OOCL、HYUNDAI、K-LINE等多家船东的物流服务代理，在国内及海外有完善的运输网络，能为客户提供全方位的服务。在日本、欧洲、地中海、美加航线上的运价有很强的竞争力。</p>
            </div>
            ...
            <div id="wlfw_con">
                            ...
                            <dl>
                                <dt>■ 海运出口业务范围</dt>
                                <dd><p>海运出口根据客户的委托，办理货物出口前后的一切业务；审核客户提供的各类清单和批件；缮制各类单证；订舱、报关；办理产地证、保险单和商检证；集装箱租赁和装箱；国内运输、进港、装船；签发提单、运杂费结算，快邮国内、外单证；办理在国外的进口报关、纳税、拆箱/转运、送货；办理在国外的代理业务。&nbsp;</p></dd>
                            </dl>
                        
                            <dl>
                                <dt>■ 海运出口操作流程</dt>
                                <dd><p>&nbsp;1、接单</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp;接受客户委托书后审核委托书内容并确认委托事项。 &nbsp; &nbsp; &nbsp; &nbsp;</p>
<div>2、订舱</div>
<div>&nbsp; &nbsp; &nbsp; &nbsp;缮制委托书向船公司订舱，取得船公司配舱回单。</div>
<div>3、 做箱</div>
<div>&nbsp; &nbsp; &nbsp; &nbsp; 车队取得设备交接单，并到堆场提取集装箱到客户工厂装货。或客户直接将货物送至指定堆场或仓库。</div>
<div>4、 报关</div>
<div>&nbsp; &nbsp; &nbsp; &nbsp;备齐完整的报关单据后开始出口海关申报，海关审查合格后放行。</div>
<div>5、提单确认</div>
<div>&nbsp; &nbsp; &nbsp; &nbsp;根据委托书缮制提单并与客户确认提单，保证提单内容的真实性和准确性。</div>
<div>6、付费</div>
<div>&nbsp; &nbsp; &nbsp; 与客户确认费用单，并收取相关费用。</div>
<div>7、签单</div>
<div>&nbsp; &nbsp; &nbsp; 根据客户要求，签发提单并邮寄客户。</div>
<div>8、返报关单</div>
<div>&nbsp; &nbsp; &nbsp; 出口报关一个月后将报关单返还客户退税核销。</div>
<div>9、目的港换提货单</div>
<div>&nbsp; &nbsp; &nbsp; 货物到达目的港后，船公司通知收货人换取提货单。</div>
<div>10、报关提货</div>
<div>&nbsp; &nbsp; &nbsp; 备齐完整的报关单据后开始进口申报，海关审查放行后提货。</div>
<div>&nbsp;</div></dd>
                            </dl>
                        
                            <dl>
                                <dt>■ 海运出口操作注意事项</dt>
                                <dd><p>1、显示在报关单上的中文品名，须根据海关商品编码审核两者是否相符， 并根据监管条件办理和提供所须报关文件。</p>
<p>2、所有的报关文件必须保证信息单单相符。</p>
<p>3、 海关可能会对所申报的货物进行查验，以确定货物情况是否与报关单上申报的信息相符。</p>
<p>4、航运旺季时，船舶容易超载，应提前办理申报手续，以防止被船公司甩载。</p>
<div>5、签发正本提单须保证每张正本提单均有签章。</div>
<p>&nbsp;&nbsp;&nbsp;&nbsp;</p></dd>
                            </dl>
        ...
        <!--[if !IE]>口岸动态开始<![endif]-->
            ...
            <div id="wlfw_news">
                <dl>
                    <dt><b>口岸动态</b><a href="${pageContext.request.contextPath}/News/KadtList-kadtDalian-1.html" target="_blank">更多&raquo;</a></dt>
                    <dd>
                        <ul>
                            
                                <li>
                                    <em>
                                        <a href="${pageContext.request.contextPath}/News/KadtList-kadtShenzhen-1.html" class="port" title="深圳口岸" target="_blank">
                                            [深圳]
                                        </a>
                                    </em>
                                    <a href="${pageContext.request.contextPath}/News/KadtDetail-2095.html" title="东南亚航线舱位较紧张" target="_blank">
                                        东南亚航线舱位较紧张
                                    </a>
                                    <span>12-01</span>
                                </li>
                                ...
                                <li>
                                    <em>
                                        <a href="${pageContext.request.contextPath}/News/KadtList-kadtGuangzhou-1.html" class="port" title="广州口岸" target="_blank">
                                            [广州]
                                        </a>
                                    </em>
                                    <a href="${pageContext.request.contextPath}/News/KadtDetail-2094.html" title="澳洲线12月预计涨价" target="_blank">
                                        澳洲线12月预计涨价
                                    </a>
                                    <span>12-01</span>
                                </li>
                                ...
                                <li>
                                    <em>
                                        <a href="${pageContext.request.contextPath}/News/KadtList-kadtXiamen-1.html" class="port" title="厦门口岸" target="_blank">
                                            [厦门]
                                        </a>
                                    </em>
                                    <a href="${pageContext.request.contextPath}/News/KadtDetail-2093.html" title="南美航线15日后预期有涨价" target="_blank">
                                        南美航线15日后预期有涨价
                                    </a>
                                    <span>12-01</span>
                                </li>
                                ...
                                <li>
                                    <em>
                                        <a href="${pageContext.request.contextPath}/News/KadtList-kadtShanghai-1.html" class="port" title="上海口岸" target="_blank">
                                            [上海]
                                        </a>
                                    </em>
                                    <a href="${pageContext.request.contextPath}/News/KadtDetail-2092.html" title="美西塞港严重预计15日起上调PCS" target="_blank">
                                        美西塞港严重预计15日起上调PCS
                                    </a>
                                    <span>12-01</span>
                                </li>
                                ...
                                <li>
                                    <em>
                                        <a href="${pageContext.request.contextPath}/News/KadtList-kadtNingbo-1.html" class="port" title="宁波口岸" target="_blank">
                                            [宁波]
                                        </a>
                                    </em>
                                    <a href="${pageContext.request.contextPath}/News/KadtDetail-2091.html" title="墨西哥、南美西航线15日以后上调GRI" target="_blank">
                                        墨西哥、南美西航线15日以后上调GRI
                                    </a>
                                    <span>12-01</span>
                                </li>
                                ...
                                <li>
                                    <em>
                                        <a href="${pageContext.request.contextPath}/News/KadtList-kadtQingdao-1.html" class="port" title="青岛口岸" target="_blank">
                                            [青岛]
                                        </a>
                                    </em>
                                    <a href="${pageContext.request.contextPath}/News/KadtDetail-2089.html" title="地中海航线运价下跌" target="_blank">
                                        地中海航线运价下跌
                                    </a>
                                    <span>12-01</span>
                                </li>
                                ...
                                <li>
                                    <em>
                                        <a href="${pageContext.request.contextPath}/News/KadtList-kadtTianjin-1.html" class="port" title="天津口岸" target="_blank">
                                            [天津]
                                        </a>
                                    </em>
                                    <a href="${pageContext.request.contextPath}/News/KadtDetail-2088.html" title="美西航线收取拥堵费全水爆舱" target="_blank">
                                        美西航线收取拥堵费全水爆舱
                                    </a>
                                    <span>12-01</span>
                                </li>
                                ...
                                <li>
                                    <em>
                                        <a href="${pageContext.request.contextPath}/News/KadtList-kadtDalian-1.html" class="port" title="大连口岸" target="_blank">
                                            [大连]
                                        </a>
                                    </em>
                                    <a href="${pageContext.request.contextPath}/News/KadtDetail-2087.html" title="12月1日起印巴航线预计小幅涨价" target="_blank">
                                        12月1日起印巴航线预计小幅涨价
                                    </a>
                                    <span>12-01</span>
                                </li>
        ...
        <div id="wlfw_news" style="margin-right: 0">
            <dl>
                <dt><b>海运资讯</b><a href="${pageContext.request.contextPath}/News/List-hyzx-1.html" target="_blank">更多&raquo;</a></dt>
                <dd>
                    <ul>
                        
                            <li><a href="${pageContext.request.contextPath}/News/DetailPage-48503.html" title="询价：星星之火" target="_blank">询价：星星之火</a><span>12/02</span></li>
                        
                            <li><a href="${pageContext.request.contextPath}/News/DetailPage-48499.html" title="香港港口华南续具优势 成本竞争力相对提升" target="_blank">香港港口华南续具优势 成本竞争力相对提升</a><span>12/02</span></li>
                        
                            <li><a href="${pageContext.request.contextPath}/News/DetailPage-48500.html" title="12月1日BDI指数" target="_blank">12月1日BDI指数</a><span>12/02</span></li>
                        
                            <li><a href="${pageContext.request.contextPath}/News/DetailPage-48501.html" title="波罗的海干散货运价指数上周五报1153点 海岬型船运价重挫" target="_blank">波罗的海干散货运价指数上周五报1153点 海岬型船运价重挫</a><span>12/02</span></li>
                        
                            <li><a href="${pageContext.request.contextPath}/News/DetailPage-48502.html" title="VLCC运价大涨 BDI回落" target="_blank">VLCC运价大涨 BDI回落</a><span>12/02</span></li>
                        
                            <li><a href="${pageContext.request.contextPath}/News/DetailPage-48475.html" title="运输需求难有改善 沿海综指低位震荡" target="_blank">运输需求难有改善 沿海综指低位震荡</a><span>12/01</span></li>
                        
                            <li><a href="${pageContext.request.contextPath}/News/DetailPage-48476.html" title="原油运价此起彼伏 成品油运价稳中有涨" target="_blank">原油运价此起彼伏 成品油运价稳中有涨</a><span>12/01</span></li>
                        
                            <li><a href="${pageContext.request.contextPath}/News/DetailPage-48477.html" title="远程矿船运有限 海岬型船运价大跌" target="_blank">远程矿船运有限 海岬型船运价大跌</a><span>12/01</span></li>
    ...
    <div class="main_right">
        ...
        <div id="right_nav">
            <h2>海运服务</h2>
            <ul>
                <li><a href="${pageContext.request.contextPath}/TransService/Detail/hyck.html" target="_blank" class="on">海运出口</a></li>
                <li><a href="${pageContext.request.contextPath}/TransService/Detail/hyjk.html" target="_blank" class="">海运进口</a></li>
                <li><a href="${pageContext.request.contextPath}/TransService/Detail/nmhy.html" target="_blank" class="">内贸海运</a></li>
                <li><a href="${pageContext.request.contextPath}/TransService/Detail/szys.html" target="_blank" class="">散杂运输</a></li>
            </ul>
        </div>
        <!--[if !IE]>分类导航结束<![endif]-->
        <!--[if !IE]>在线咨询<![endif]-->
