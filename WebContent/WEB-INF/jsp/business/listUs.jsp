...
<div id="Title_bar">
    <div id="Title_bar_Head"> 
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 公司列表
        </div>
...
<div id="MainArea">
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <tbody id="TableData" class="dataContainer" datakey="userList">
        	<s:iterator value="%{aboutUsList}"  id = "c"   status = "s">
            <tr  class="TableDetail1 template">
	                <td align="center" nowrap = "nowrap"><s:property value ="%{#s.count}"/></td >
	                <td>${name}&nbsp;</td>
	                <td align="center">
	                    <s:a action="businessAction_findUs?id=%{id}">修改</s:a>
	                </td>
	            </tr>
            </s:iterator>
        </tbody>
