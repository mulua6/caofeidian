...
<link href="${pageContext.request.contextPath}/style/zTreeStyle/zTreeStyle.css" rel="stylesheet" type="text/css" />
	<script  src="${pageContext.request.contextPath}/style/js/jquery-ztree-2.5.js"></script>
	<script language="javascript" src="${pageContext.request.contextPath}/style/js/jquery-plugin-tree.js"></script>
	<script language="javascript" src="${pageContext.request.contextPath}/style/js/kynamicO.js"></script>
<HTML>
<HEAD>
	<TITLE>知识管理</TITLE>
...
<DIV ID="addVersion" STYLE="margin-left: 3px; width: 700px; float: left;display:none;" border="3">
  ...
  <tr>
    ...
    <td width="540" bgcolor="#F0F7FD"><input name="title" type="text" style="background-color: #FFFFFF;
  ...
  <tr>
    ...
    <td bgcolor="#F0F7FD"><textarea name="content" cols="" rows="" style="background-color: #FFFFFF;
    border: 1px solid #91C0E3;
...
<DIV ID="versionList" STYLE="margin-left: 3px; width: 700px; float: left; display:none;" border="2">
  ...
  <tr>
    <td><table id="versionTable" width="700" border="0" cellspacing="0" cellpadding="0">
</table>
</td>
  </tr>
</table>
