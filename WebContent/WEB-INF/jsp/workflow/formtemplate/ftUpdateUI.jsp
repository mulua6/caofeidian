...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="formTemplateAction_update.action" enctype="multipart/form-data">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
				   	<tr>
                        <td>模板名称</td>
                        <s:hidden name="ftid" value="%{ftid}"></s:hidden>
                        <td><s:textfield name="name" cssClass="InputStyle" value="%{name}"></s:textfield></td>
                    </tr>
                    <tr>
                        <td>所用流程</td>
