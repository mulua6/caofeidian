...
<head>
	...
	<script language="javascript" src="${pageContext.request.contextPath}/style/js/approveSubmit.js" charset="utf-8"></script>
...
<div id=MainArea>
    <s:form id= "form" name= "form" action="">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					<tr>
						<td><s:a action="workflowAction_download?fid=%{fid}" style="text-decoration: underline">[点击下载申请的文档]</s:a></td>
					</tr>
                </table>
            </div>
        </div>
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        <td>审批意见</td>
                        <s:hidden name="fid" value="%{fid}"></s:hidden>
                        <s:hidden name="taskId" value="%{taskId}"></s:hidden>
                        <td><s:textarea name="comment" cssClass="TextareaStyle" style="width: 500px;"></s:textarea>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div id="InputDetailBar" style="float:none">
			...
			<input id="agree" type="image" src="${pageContext.request.contextPath}/style/blue/images/button/agree.png"/>
			<input id="disagree" type="image" src="${pageContext.request.contextPath}/style/blue/images/button/disagree.png"/>
