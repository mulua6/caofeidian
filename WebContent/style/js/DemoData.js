...
var demoData = {
	...
	userList:[
		{ "user.loginName": "wxr", "user.name": "王欣然", "user.department": "研发部", "user.roles": "程序员", "user.description": "" },
		{ "user.loginName": "cp", "user.name": "崔鹏", "user.department": "研发部", "user.roles": "程序员", "user.description": "" },
		{ "user.loginName": "zpf", "user.name": "赵鹏飞", "user.department": "测试部", "user.roles": "测试员", "user.description": "" }
	], 
	menuList:[
